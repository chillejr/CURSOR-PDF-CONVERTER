...
- convert:   Extract, translate, and save to a new PDF
...
def _cmd_gui(_: argparse.Namespace) -> int:
    # Lazy import to avoid tkinter dependency for non-GUI usage
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_convert = subparsers.add_parser("convert", help="Extract, translate, and save a new PDF")
